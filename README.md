...
- [x] 20. Remove the K'th element from a list. (easy)  [[finished]](main.ml#L199) 
- [x] 21. Insert an element at a given position into a list. (easy)  [[finished]](main.ml#L205) 
- [x] 22. Create a list containing all integers within a given range. (easy)  [[finished]](main.ml#L213) 
- [ ] 23. Extract a given number of randomly selected elements from a list. (medium) 
- [ ] 24. Lotto: Draw N different random numbers from the set 1..M. (easy) 
- [x] 25. Generate a random permutation of the elements of a list. (easy)  [[finished]](main.ml#L221) 
...
- [x] 39. A list of prime numbers. (easy)  [[finished]](main.ml#L247) 
